...
import { TRANSACTION_STACK_EXCEPTION, jsTPS } from '../index.js';
...
test('Test #10) undoing a transaction on an empty stack, should throw an exception', () => {
    ...
    expect(() => tps.undoTransaction()).toThrow(TRANSACTION_STACK_EXCEPTION);
...
test('Test #12) redoing a transaction on an empty stack, should throw an exception', () => {
    ...
    expect(() => tps.doTransaction()).toThrow(TRANSACTION_STACK_EXCEPTION);
